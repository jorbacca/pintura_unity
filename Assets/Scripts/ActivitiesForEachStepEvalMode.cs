...
public class ActivitiesForEachStepEvalMode : MonoBehaviour {
	...
	//variables booleanas para controlar si los botones deben estar activos o no:
	public bool btn_one_enable;
	public bool btn_two_enable;
	public bool btn_three_enable;
	public bool btn_four_enable;
	public bool btn_five_enable;
	public bool btn_six_enable;
	public bool btn_seven_enable;
	...
	void Start () {
		...
		Debug.Log ("Llamado al metodo START de Activities for each step");
		...
		if (titulo_object != null) {
			...
			Debug.LogError("El titulo de la interfaz sera: " + titulo_current_step);
		}
		...
		if (toolsAndProducts != null) {
			if(btn_one_enable){
				...
				toolsAndProducts.GetComponent<Image>().enabled = false;
			}
		}
		...
		if (videos != null) {
			if(btn_two_enable){
				...
				videos.GetComponent<Image>().enabled = false;
			}
		}
		...
		if (selfAssessment != null) {
			if(btn_three_enable){
				...
				selfAssessment.GetComponent<Image>().enabled = false;
			}
		}
		...
		if (simulations != null) {
			if(btn_four_enable){
				...
				simulations.GetComponent<Image>().enabled = false;
			}
		}
		...
		if (personalNotes != null) {
			if(btn_five_enable){
				...
				personalNotes.GetComponent<Image>().enabled = false;
			}
		}
		...
		if (frequenltyAskedQuest != null) {
			if(btn_six_enable){
				...
				frequenltyAskedQuest.GetComponent<Image>().enabled = false;
			}
		}
		...
		if (askYourTeacher != null) {
			if(btn_seven_enable){
				...
				askYourTeacher.GetComponent<Image>().enabled = false;
			}
		}
