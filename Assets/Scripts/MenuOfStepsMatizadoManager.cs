...
public class MenuOfStepsMatizadoManager : MonoBehaviour {
	...
	public System.Action goToActionButtoOne;
	public System.Action goToActionButtoTwo;
	public System.Action goToActionButtoThree;
	public System.Action goToActionButtoFour;
	public System.Action goToActionButtoFive;
	public System.Action goToActionButtoSix;
		...
		*/
		...
		if (button_one != null) {
			if(step_one_btn_visible){
				...
				button_one.onClick.AddListener(()=>{ActionButton_goToActionBtnOne();});
		...
		if (button_two != null) {
			if(step_two_btn_visible){
				...
				button_two.onClick.AddListener(()=>{ActionButton_goToActionBtnTwo();});
		...
		if (button_three != null) {
			if(step_three_btn_visible){
				...
				button_three.onClick.AddListener(()=>{ActionButton_goToActionBtnThree();});
		...
		if (button_four != null) {
			if(step_four_btn_visible){
				...
				button_four.onClick.AddListener(()=>{ActionButton_goToActionBtnFour();});
		...
		if (button_five != null) {
			if(step_five_btn_visible){
				...
				button_five.onClick.AddListener(()=>{ActionButton_goToActionBtnFive();});
		...
		if (button_six != null) {
			if(step_six_btn_visible){
				...
				//Agregando la accion para ir al conjunto de actividades (5. corregir irregularidades):
				button_six.onClick.AddListener(()=>{ActionButton_goToActionBtnSix();});
